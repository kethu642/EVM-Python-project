...
def win2():
    ...
    frame1 = tk.Frame(win2.window2, width=400, height=600, bg="grey")
    frame1.pack()

    label1 = tk.Label(win2.window2, text="V.V.P.A.T",width=14, relief=RIDGE, bg="lime green", borderwidth=5)
    ...
    btn1 = tk.Button(frame2, text="Rate Us", width=10, relief=RAISED, borderwidth=5, bg="blue",command=rating)
    btn1.config(font=('Arial bold', 10))
    btn1.grid(row=0, column=0, padx=17)
    btn2 = tk.Button(frame2, text="Reset", width=10, relief=RAISED, borderwidth=5, bg="hot pink")
